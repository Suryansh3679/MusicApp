...
android {
    namespace = "app.proj.musicappui"
    compileSdk = 34

    defaultConfig {
        applicationId = "app.proj.musicappui"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation ("androidx.activity:activity-compose:1.6.0-alpha08")

    // Optional: if you want to use compose navigation
